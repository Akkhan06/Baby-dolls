            ...
            <div className="xl:w-9/12 w-11/12 mx-auto xl:mx-0">
              <div className="rounded relative mt-8 h-48">
                ...
                <div className="w-20 h-20 rounded-full bg-cover bg-center bg-no-repeat absolute bottom-0 -mb-10 ml-12 shadow flex items-center justify-center">
                  ...
                  <div className="cursor-pointer flex flex-col justify-center items-center z-10 text-gray-100"></div>
                </div>
              </div>
              ...
              <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                ...
                <div className="border border-gray-300 dark:border-gray-700 shadow-sm rounded flex">
                  <input
                    ...
                    defaultValue={
                      "https://img.freepik.com/free-vector/little-cute-girl-holding-teddy-bear_1308-115895.jpg?w=360&t=st=1684507206~exp=1684507806~hmac=1f4053f20302a4209b5d24f3363d0e7955b4dd681eca9263f460d3969ccaad79"
                    }
                  />
